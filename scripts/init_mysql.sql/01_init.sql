CREATE TABLE IF NOT EXISTS customers_raw (
    ...
    dob VARCHAR(20), created_at DATETIME
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS sales_raw (
    vin VARCHAR(20) PRIMARY KEY, customer_id INT,
    model VARCHAR(50), invoice_date DATE,
    price VARCHAR(20), created_at DATETIME
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS after_sales_raw (
    service_ticket VARCHAR(20) PRIMARY KEY, vin VARCHAR(20),
    customer_id INT, model VARCHAR(50),
    service_date DATE, service_type VARCHAR(5), created_at DATETIME
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
